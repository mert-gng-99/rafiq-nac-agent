...
For Rafiq: at SIM hand-over on arrival, in one clear line with the pack, from the pilgrim, who owns the agency SIM for the duration of the trip and is the line owner CAMARA requires. The grant expires the day the trip ends, with no action needed by anyone.
